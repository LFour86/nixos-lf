...
A declarative NixOS system configuration using Nix flakes, featuring a customized desktop environment with 3N (NixOS + Niri + Noctalia) 、 GNOME and various productivity tools.
...
- **Hardware Partitioning**: This config use `disko`, so you have to change the `system/hardware/disko.nix`.
