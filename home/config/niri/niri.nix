{
  xdg.configFile."niri/config.kdl".text = ''
    ...
    spawn-at-startup "swww" "img" "/home/lfour/Pictures/Wallpapers/moon.jpg"

    // General Settings
    prefer-no-csd
    screenshot-path "~/Pictures/Wallpapers/%Y-%m-%d-%H-%M-%S.jpg"
    ...
    binds {
      ...
      Mod+Z hotkey-overlay-title="Open a Terminal: alacritty" { spawn "alacritty"; }
