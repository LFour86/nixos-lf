{ pkgs, inputs, ... }:
{
  ...
  programs.noctalia-shell = {
    ...
    settings = {
      ...
      wallpaper = {
        ...
        directory = "/home/lfour/Pictures/Wallpapers";
        monitorDirectories = [];
  ...
  home.file.".cache/noctalia/wallpapers.json" = {
    text = builtins.toJSON {
      defaultWallpaper = "/etc/nixos/home/wallpapers/atri.png";
      wallpapers = {
        "eDP-1" = "/etc/nixos/home/wallpapers/atri.png";
      };
    };
  };
}
